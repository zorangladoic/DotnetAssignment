...
namespace FlowrSpot.Infrastructure.Migrations
{
    ...
    [Migration("20231219183228_UpdateSightingUserLikeFlowerTableRelations")]
    partial class UpdateSightingUserLikeFlowerTableRelations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FlowrSpot.Domain.Entities.Sighting", b =>
                {
                    b.HasOne("FlowrSpot.Domain.Entities.Flower", "Flower")
                        .WithOne("Sighting")
                        .HasForeignKey("FlowrSpot.Domain.Entities.Sighting", "FlowerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
